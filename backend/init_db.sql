...
-- ============================================================================
-- 9. CAMPAIGNS TABLE (depends on users, telegram_accounts, jobs)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS ix_campaigns_telegram_account_id ON campaigns(telegram_account_id);
CREATE INDEX IF NOT EXISTS ix_campaigns_status ON campaigns(status);

-- ============================================================================
-- 10. CAMPAIGN_USER_INTERACTIONS TABLE (depends on campaigns)
-- ============================================================================
CREATE TABLE IF NOT EXISTS campaign_user_interactions (
    id SERIAL PRIMARY KEY,
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE(campaign_id, target_user_id)
);
CREATE INDEX IF NOT EXISTS ix_campaign_user_interactions_id ON campaign_user_interactions(id);
CREATE INDEX IF NOT EXISTS ix_campaign_user_interactions_campaign_id ON campaign_user_interactions(campaign_id);

-- ============================================================================
-- 11. CAMPAIGN_PENDING_TASKS TABLE (depends on campaign_user_interactions)
-- ============================================================================
CREATE TABLE IF NOT EXISTS campaign_pending_tasks (
    id SERIAL PRIMARY KEY,
    campaign_user_interaction_id INTEGER NOT NULL REFERENCES campaign_user_interactions(id) ON DELETE CASCADE,
    celery_task_id VARCHAR(255) UNIQUE,
    task_type VARCHAR(50) NOT NULL,
    scheduled_for TIMESTAMP NOT NULL,
    status VARCHAR(20) DEFAULT 'pending',
    reason_paused VARCHAR(255),
    retry_count INTEGER DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
CREATE INDEX IF NOT EXISTS ix_campaign_pending_tasks_id ON campaign_pending_tasks(id);
CREATE INDEX IF NOT EXISTS ix_campaign_pending_tasks_interaction_id ON campaign_pending_tasks(campaign_user_interaction_id);
CREATE INDEX IF NOT EXISTS ix_campaign_pending_tasks_scheduled_for ON campaign_pending_tasks(scheduled_for);
CREATE INDEX IF NOT EXISTS ix_campaign_pending_tasks_status ON campaign_pending_tasks(status);

-- ============================================================================
-- 12. CAMPAIGN_MESSAGE_TRACKING TABLE (depends on campaign_user_interactions)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS ix_campaign_message_tracking_id ON campaign_message_tracking(id);
CREATE INDEX IF NOT EXISTS ix_campaign_message_tracking_interaction_id ON campaign_message_tracking(campaign_user_interaction_id);
CREATE INDEX IF NOT EXISTS ix_campaign_message_tracking_idempotency_key ON campaign_message_tracking(idempotency_key);

-- ============================================================================
-- 13. CAMPAIGN_REPLIES TABLE (depends on campaign_user_interactions)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS ix_campaign_replies_id ON campaign_replies(id);
CREATE INDEX IF NOT EXISTS ix_campaign_replies_interaction_id ON campaign_replies(campaign_user_interaction_id);

-- ============================================================================
-- 14. CAMPAIGN_LOGS TABLE (depends on campaigns, campaign_user_interactions)
-- ============================================================================
CREATE TABLE IF NOT EXISTS campaign_logs (
    id SERIAL PRIMARY KEY,
    campaign_id INTEGER NOT NULL REFERENCES campaigns(id) ON DELETE CASCADE,
    campaign_user_interaction_id INTEGER REFERENCES campaign_user_interactions(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS ix_campaign_logs_id ON campaign_logs(id);
CREATE INDEX IF NOT EXISTS ix_campaign_logs_campaign_id ON campaign_logs(campaign_id);
CREATE INDEX IF NOT EXISTS ix_campaign_logs_interaction_id ON campaign_logs(campaign_user_interaction_id);
CREATE INDEX IF NOT EXISTS ix_campaign_logs_created_at ON campaign_logs(created_at);

-- ============================================================================
-- 15. MESSAGE_TEMPLATES TABLE (depends on users)
-- ============================================================================
